...
/**
 * @extends ServiceEntityRepository<AttachmentType>
 *
...
class AttachmentTypeRepository extends ServiceEntityRepository
{
    ...
    //    /**
    //     * @return AttachmentType[] Returns an array of AttachmentType objects
    //     */
    ...
    //    public function findOneBySomeField($value): ?AttachmentType
    //    {
    //        return $this->createQueryBuilder('a')
    //            ->andWhere('a.exampleField = :val')
    //            ->setParameter('val', $value)
