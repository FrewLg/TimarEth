  ...
  var t = {},
    ...
    l = function () {
      $('[data-card="true"]').each(function () {
        var t = $(this);
        !0 !== t.data("data-card-initialized") &&
          (o(t, {}), t.data("data-card-initialized", !0));
      });
    };
  return {
    init: function (e) {
    ...
    initComponents: function () {
      $('[data-scroll="true"]').each(function () {
        ...
        KTUtil.scrollInit(this, {
          ...
          height: function () {
            return KTUtil.isBreakpointDown("lg") && t.data("mobile-height")
    ...
    var o = {
      ...
      l = {
        construct: function (t) {
          return (
            KTUtil.data(n).has("card")
              ? (a = KTUtil.data(n).get("card"))
              : (l.init(t), l.build(), KTUtil.data(n).set("card", a)),
            a
          );
        },
        init: function (t) {
          (a.element = n),
            ...
            KTUtil.child(n, ".card-body")
              ? (a.body = KTUtil.child(n, ".card-body"))
              : KTUtil.child(n, ".form") && (a.body = KTUtil.child(n, ".form"));
        },
        build: function () {
          ...
          var i = KTUtil.find(a.header, "[data-card-tool=fullscreen]");
          i &&
        ...
        onScrollSticky: function (t) {
          ...
          if (!isNaN(e)) {
            ...
            n >= e && !1 === KTUtil.hasClass(i, "card-sticky-on")
              ? (l.eventTrigger("stickyOn"),
                KTUtil.addClass(i, "card-sticky-on"),
                l.updateSticky())
              : 1.5 * n <= e &&
                KTUtil.hasClass(i, "card-sticky-on") &&
        ...
        resetSticky: function () {
          a.header &&
            !1 === KTUtil.hasClass(i, "card-sticky-on") &&
            (KTUtil.css(a.header, "z-index", ""),
        ...
        remove: function () {
          !1 !== l.eventTrigger("beforeRemove") &&
            (KTUtil.hasClass(i, "card-fullscreen") &&
              KTUtil.hasClass(n, "card-fullscreen") &&
              l.fullscreen("off"),
            l.removeTooltips(),
            KTUtil.remove(n),
        ...
        setupTooltips: function () {
          if (a.options.tooltips) {
            var t =
                KTUtil.hasClass(n, "card-collapse") ||
                KTUtil.hasClass(n, "card-collapsed"),
              e =
                KTUtil.hasClass(i, "card-fullscreen") &&
                KTUtil.hasClass(n, "card-fullscreen"),
              o = KTUtil.find(a.header, "[data-card-tool=remove]");
            if (o) {
              var l = e ? "bottom" : "top",
                r = new Tooltip(o, {
            ...
            var d = KTUtil.find(a.header, "[data-card-tool=toggle]");
            if (d) {
              (l = e ? "bottom" : "top"),
                (r = new Tooltip(d, {
                  title: t
            ...
            var c = KTUtil.find(a.header, "[data-card-tool=fullscreen]");
            if (c) {
              (l = e ? "bottom" : "top"),
                (r = new Tooltip(c, {
                  title: e
        ...
        collapse: function () {
          if (!1 !== l.eventTrigger("beforeCollapse")) {
            ...
            var t = KTUtil.find(a.header, "[data-card-tool=toggle]");
            t &&
              KTUtil.data(t).has("tooltip") &&
              KTUtil.data(t)
                .get("tooltip")
        ...
        fullscreen: function (t) {
          if (
            ...
            l.eventTrigger("beforeFullscreenOff"),
              KTUtil.removeClass(i, "card-fullscreen"),
              KTUtil.removeClass(n, "card-fullscreen"),
              l.removeTooltips(),
              l.setupTooltips(),
              a.footer &&
                (KTUtil.css(a.body, "margin-bottom", ""),
                KTUtil.css(a.footer, "margin-top", "")),
              l.eventTrigger("afterFullscreenOff");
          else {
            if (
              (l.eventTrigger("beforeFullscreenOn"),
              KTUtil.addClass(n, "card-fullscreen"),
              KTUtil.addClass(i, "card-fullscreen"),
              l.removeTooltips(),
              l.setupTooltips(),
              a.footer)
            ) {
              var e = parseInt(KTUtil.css(a.footer, "height")),
                o =
                  parseInt(KTUtil.css(a.footer, "height")) +
                  parseInt(KTUtil.css(a.header, "height"));
              KTUtil.css(a.body, "margin-bottom", e + "px"),
                KTUtil.css(a.footer, "margin-top", "-" + o + "px");
            }
        ...
        eventTrigger: function (t) {
          for (var e = 0; e < a.events.length; e++) {
            ...
            if (n.name == t) {
              ...
              if (0 == n.fired)
                return (a.events[e].fired = !0), n.handler.call(this, a);
            }
          }
        },
...
var KTCookie = {
  ...
  setCookie: function (t, e, a) {
    a || (a = {}),
      (a = Object.assign({}, { path: "/" }, a)).expires instanceof Date &&
    ...
    o = {
      ...
      show: function () {
        return (
          ...
          KTUtil.addClass(e, "dialog dialog-shown"),
          KTUtil.addClass(e, "dialog-" + a.options.state),
          KTUtil.addClass(e, "dialog-" + a.options.type),
          "top center" == a.options.placement &&
            KTUtil.addClass(e, "dialog-top-center"),
          n.appendChild(e),
          (a.state = "shown"),
...
var KTHeader = function (t, e) {
  ...
  if (void 0 !== n) {
    var o = {
        offset: { desktop: !0, tabletAndMobile: !0 },
        releseOnReverse: { desktop: !1, tabletAndMobile: !1 },
      },
      l = {
        construct: function (t) {
          return (
        ...
        build: function () {
          var t = !0,
            e = (KTUtil.getViewPort().height, KTUtil.getDocumentHeight(), 0);
          window.addEventListener("scroll", function () {
            var n,
              o = 0;
            (KTUtil.isBreakpointDown("lg") &&
              !1 === a.options.offset.tabletAndMobile) ||
              (KTUtil.isBreakpointUp("lg") &&
                !1 === a.options.offset.desktop) ||
              (KTUtil.isBreakpointUp("lg")
                ? (o = a.options.offset.desktop)
                : KTUtil.isBreakpointDown("lg") &&
                  (o = a.options.offset.tabletAndMobile),
              (n = KTUtil.getScrollTop()),
              (KTUtil.isBreakpointDown("lg") &&
                a.options.releseOnReverse.tabletAndMobile) ||
              (KTUtil.isBreakpointUp("lg") && a.options.releseOnReverse.desktop)
                ? (n > o && e < n
                    ? (!1 === i.hasAttribute("data-header-scroll") &&
                        i.setAttribute("data-header-scroll", "on"),
                      t && (l.eventTrigger("scrollOn", a), (t = !1)))
                    : (!0 === i.hasAttribute("data-header-scroll") &&
                        i.removeAttribute("data-header-scroll"),
                      0 == t && (l.eventTrigger("scrollOff", a), (t = !0))),
                  (e = n))
                : n > o
                ? (!1 === i.hasAttribute("data-header-scroll") &&
                    i.setAttribute("data-header-scroll", "on"),
        ...
        eventTrigger: function (t, e) {
          for (var n = 0; n < a.events.length; n++) {
            ...
            if (i.name == t) {
              ...
              if (0 == i.fired)
                return (a.events[n].fired = !0), i.handler.call(this, a, e);
            }
          }
        },
        addEvent: function (t, e, n) {
  ...
  if (n) {
    var i = { editMode: !1 },
      o = {
        construct: function (t) {
          return (
            KTUtil.data(n).has("imageinput")
              ? (a = KTUtil.data(n).get("imageinput"))
              : (o.init(t), o.build(), KTUtil.data(n).set("imageinput", a)),
            a
          );
        },
        init: function (t) {
        ...
        build: function () {
          KTUtil.addEvent(a.input, "change", function (t) {
            if (
              (t.preventDefault(), a.input && a.input.files && a.input.files[0])
            ) {
      ...
      r = {
        ...
        getSubmenuMode: function (t) {
          return KTUtil.isBreakpointUp("lg")
            ? t &&
              KTUtil.hasAttr(t, "data-menu-toggle") &&
              "hover" == KTUtil.attr(t, "data-menu-toggle")
              ? "dropdown"
        ...
        handleSubmenuDropdownClick: function (t) {
          if ("accordion" !== r.getSubmenuMode(this)) {
            ...
            !1 !== r.eventTrigger("submenuToggle", this, t) &&
              "accordion" != e.getAttribute("data-menu-submenu-mode") &&
              (!1 === KTUtil.hasClass(e, "menu-item-hover")
                ? (KTUtil.addClass(e, "menu-item-open-dropdown"),
                  r.showSubmenuDropdown(e))
                : (KTUtil.removeClass(e, "menu-item-open-dropdown"),
                  r.hideSubmenuDropdown(e, !0)),
              t.preventDefault());
          }
        },
        handleSubmenuDropdownTabClick: function (t) {
          if ("accordion" !== r.getSubmenuMode(this)) {
            ...
            !1 !== r.eventTrigger("submenuToggle", this, t) &&
              "accordion" != e.getAttribute("data-menu-submenu-mode") &&
              (0 == KTUtil.hasClass(e, "menu-item-hover") &&
                (KTUtil.addClass(e, "menu-item-open-dropdown"),
                r.showSubmenuDropdown(e)),
              t.preventDefault());
          }
        ...
        handleSubmenuDropdownClose: function (t, e) {
          if ("accordion" !== r.getSubmenuMode(e)) {
            ...
            if (
              a.length > 0 &&
              !1 === KTUtil.hasClass(e, "menu-toggle") &&
              0 === e.querySelectorAll(".menu-toggle").length
            )
        ...
        handleSubmenuAccordion: function (t, e) {
          ...
          if (!1 !== r.eventTrigger("submenuToggle", this, t))
            if (
              ...
              "accordion" != n.getAttribute("data-menu-submenu-mode")
            )
              t.preventDefault();
            else {
                      ...
                      for (var u = 0, p = c.length; u < p; u++) {
                        ...
                        g &&
                          KTUtil.slideUp(g, s, function () {
                            r.scrollUpdate(),
                              KTUtil.removeClass(f, "menu-item-open");
                          });
                      }
                  }
        ...
        hideSubmenuDropdown: function (t, e) {
          e &&
            (KTUtil.removeClass(t, "menu-item-hover"),
            KTUtil.removeClass(t, "menu-item-active-tab")),
            t.removeAttribute("data-hover"),
            t.getAttribute("data-menu-toggle-class") &&
              KTUtil.removeClass(o, t.getAttribute("data-menu-toggle-class"));
        ...
        showSubmenuDropdown: function (t) {
          ...
          KTUtil.addClass(t, "menu-item-hover"),
            t.getAttribute("data-menu-toggle-class") &&
              KTUtil.addClass(o, t.getAttribute("data-menu-toggle-class"));
        },
        createSubmenuDropdownClickDropoff: function (t) {
          var e,
            a =
              (e = KTUtil.child(t, ".menu-submenu")
        ...
        resetActiveItem: function (t) {
          for (
            var e,
              n,
              o = 0,
              l = (e = i.querySelectorAll(".menu-item-active")).length;
            o < l;
            o++
          ) {
            var r = e[0];
            KTUtil.removeClass(r, "menu-item-active"),
              KTUtil.hide(KTUtil.child(r, ".menu-submenu"));
            for (
              var s = 0,
                d = (n = KTUtil.parents(r, ".menu-item-submenu") || []).length;
              s < d;
              s++
            ) {
              var c = n[o];
              KTUtil.removeClass(c, "menu-item-open"),
                KTUtil.hide(KTUtil.child(c, ".menu-submenu"));
            }
          }
          if (
            !1 === a.options.accordion.expandAll &&
            (e = i.querySelectorAll(".menu-item-open"))
          )
        ...
        setActiveItem: function (t) {
          r.resetActiveItem();
          for (
            var e = KTUtil.parents(t, ".menu-item-submenu") || [],
              a = 0,
              n = e.length;
            a < n;
            a++
        ...
        getBreadcrumbs: function (t) {
          ...
          for (
            var i = KTUtil.parents(t, ".menu-item-submenu"),
              o = 0,
              l = i.length;
            o < l;
            o++
        ...
        eventTrigger: function (t, e, n) {
          for (var i = 0; i < a.events.length; i++) {
            ...
            if (o.name == t) {
              ...
              if (0 == o.fired)
                return (a.events[i].fired = !0), o.handler.call(this, e, n);
            }
          }
        },
        addEvent: function (t, e, n) {
...
"undefined" != typeof module &&
  ...
  document.addEventListener("click", function (t) {
    var e;
    if (
      (e = KTUtil.getByTagName("body")[0].querySelectorAll(
      ...
      l = {
        ...
        init: function (t) {
          (a.events = []),
            ...
            (a.classCustom = a.options.customClass),
        ...
        build: function () {
          if (a.options.toggleBy)
            if ("string" == typeof a.options.toggleBy)
              KTUtil.addEvent(
                KTUtil.getById(a.options.toggleBy),
                "click",
                function (t) {
              ...
              if (a.options.toggleBy[0].target)
                for (var t in a.options.toggleBy)
                  KTUtil.addEvent(
                    KTUtil.getById(a.options.toggleBy[t].target),
                    "click",
                    function (t) {
                      t.preventDefault(), (a.target = this), l.toggle();
                    }
                ...
                for (var t in a.options.toggleBy)
                  KTUtil.addEvent(
                    KTUtil.getById(a.options.toggleBy[t]),
                    "click",
                    function (t) {
                      t.preventDefault(), (a.target = this), l.toggle();
                    }
              ...
              a.options.toggleBy &&
                ...
                KTUtil.addEvent(
                  KTUtil.getById(a.options.toggleBy.target),
                  "click",
                  function (t) {
                    t.preventDefault(), (a.target = this), l.toggle();
                  }
        ...
        show: function () {
          "shown" != a.state &&
            ...
            a.classCustom.length > 0 && KTUtil.addClass(i, a.classCustom),
            (a.state = "shown"),
            a.options.overlay &&
              ...
              KTUtil.addEvent(a.overlay, "click", function (t) {
                t.stopPropagation(), t.preventDefault(), l.hide(a.target);
              })),
        ...
        hide: function () {
          "hidden" != a.state &&
            ...
            KTUtil.addClass(i, a.classPush),
            KTUtil.removeClass(n, a.classShown),
            a.classCustom.length > 0 && KTUtil.removeClass(i, a.classCustom),
            (a.state = "hidden"),
        ...
        toggleClass: function (t) {
          ...
          if (
            ...
            a.options.toggleBy &&
              a.options.toggleBy.target &&
              (e = a.options.toggleBy);
          if (e) {
            var o = KTUtil.getById(e.target);
            "show" === t && KTUtil.addClass(o, e.state),
              "hide" === t && KTUtil.removeClass(o, e.state);
          }
        },
        eventTrigger: function (t, e) {
          for (var n = 0; n < a.events.length; n++) {
  ...
  if (n) {
    var o = { offset: 300, speed: 6e3 },
      l = {
        ...
        handle: function () {
          KTUtil.getScrollTop() > a.options.offset
    ...
    var i = {
      ...
      init: function (t) {
        (a.element = n),
          (a.events = []),
          (a.options = t),
          (a.target = KTUtil.getById(a.options.target)),
      ...
      toggleOn: function () {
        return (
          ...
          a.toggleState && KTUtil.addClass(n, a.toggleState),
          (a.state = "on"),
      ...
      toggleOff: function () {
        return (
          ...
          a.toggleState && KTUtil.removeClass(n, a.toggleState),
          (a.state = "off"),
...
var KTUtil = (function () {
  var t = [],
    e = { sm: 544, md: 768, lg: 992, xl: 1200 },
    a = function () {
  ...
  return {
    ...
    getHighestZindex: function (t) {
      for (var e, a; t && t !== document; ) {
        if (
          ("absolute" === (e = KTUtil.css(t, "position")) ||
            "relative" === e ||
            "fixed" === e) &&
          ((a = parseInt(KTUtil.css(t, "z-index"))), !isNaN(a) && 0 !== a)
        )
          return a;
        t = t.parentNode;
      }
    ...
    data: function (t) {
      return {
        set: function (e, a) {
          t &&
            (void 0 === t.customDataTag &&
              ...
              (t.customDataTag = window.KTUtilElementDataStoreID)),
            void 0 === window.KTUtilElementDataStore[t.customDataTag] &&
        ...
        remove: function (e) {
          t &&
            this.has(e) &&
            delete window.KTUtilElementDataStore[t.customDataTag][e];
        },
      };
    },
    ...
    on: function (t, e, a, n) {
      if (e) {
        ...
        return (
          ...
          KTUtil.addEvent(t, a, window.KTUtilDelegatedEventHandlers[i]),
          i
        );
      }
    },
    off: function (t, e, a) {
      t &&
        ...
        (KTUtil.removeEvent(t, e, window.KTUtilDelegatedEventHandlers[a]),
      ...
      t.addEventListener(e, function e(n) {
        return (
          n.target &&
            ...
            n.target.removeEventListener(n.type, e),
          t &&
    ...
    scrollInit: function (t, e) {
      function a() {
        var a, n;
        if (
          !1 !== (n = e.height instanceof Function ? e.height.call() : e.height)
        )
          if (
            ((n = parseInt(n)),
            ...
            "true" == KTUtil.attr(t, "data-window-scroll") &&
              (e.windowScroll = !0),
              (a = KTUtil.data(t).get("ps"))
                ? a.update()
                : (KTUtil.css(t, "overflow", "hidden"),
                  KTUtil.addClass(t, "scroll"),
    ...
    scrollDestroy: function (t, e) {
      ...
      a && (a.destroy(), (a = KTUtil.data(t).remove("ps"))),
        t &&
          e &&
    ...
    colorDarken: function (t, e) {
      var a = function (t, e) {
        var a = parseInt(t, 16) - e,
          n = a < 0 ? 0 : a;
        return (n =
      ...
      return (
        ...
        `#${a(t.substring(0, 2), e)}${a(t.substring(2, 4), e)}${a(
          t.substring(4, 6),
          e
        )}`
      );
    },
    colorLighten: function (t, e) {
      var a = function (t, e) {
        var a = parseInt(t, 16) + e,
          n = a > 255 ? 255 : a;
        return (n =
...
var KTWizard = function (t, e) {
  ...
  KTUtil.getBody();
  if (n) {
    var i = { startStep: 1, clickableSteps: !1 },
      o = {
        construct: function (t) {
          return (
        ...
        build: function () {
          KTUtil.addEvent(a.btnNext, "click", function (t) {
            ...
            !0 === a.options.clickableSteps &&
              KTUtil.on(n, '[data-wizard-type="step"]', "click", function () {
        ...
        updateUI: function () {
          ...
          if (n && n.length > 0)
            for (var i = 0, l = n.length; i < l; i++)
              i == e
                ? KTUtil.attr(n[i], "data-wizard-state", "current")
                : i < e
                ? KTUtil.attr(n[i], "data-wizard-state", "done")
                : KTUtil.attr(n[i], "data-wizard-state", "pending");
          var r = KTUtil.findAll(a.element, '[data-wizard-type="step-info"]');
          if (r && r.length > 0)
            for (i = 0, l = r.length; i < l; i++)
              i == e
                ? KTUtil.attr(r[i], "data-wizard-state", "current")
                : KTUtil.removeAttr(r[i], "data-wizard-state");
          ...
          if (s && s.length > 0)
            for (i = 0, l = s.length; i < l; i++)
              i == e
                ? KTUtil.attr(s[i], "data-wizard-state", "current")
                : KTUtil.removeAttr(s[i], "data-wizard-state");
        },
        ...
        eventTrigger: function (t, e) {
          for (var n = 0; n < a.events.length; n++) {
            ...
            if (i.name == t) {
              ...
              if (0 == i.fired)
                return (a.events[n].fired = !0), i.handler.call(this, a);
            }
          }
        },
        addEvent: function (t, e, n) {
      ...
      if (0 !== t(this).length) {
        ...
        var l = {
          ...
          init: function (e) {
            ...
            null === e.data.source && (l.extractTable(), (n = !0)),
              ...
              t.each(l.getOption("extensions"), function (e, a) {
                "function" == typeof t.fn.KTDatatable[e] &&
                  ("object" != typeof a && (a = t.extend({}, a)),
                  new t.fn.KTDatatable[e](o, a));
              }),
              l.spinnerCallback(!0),
              ("remote" !== e.data.type && "local" !== e.data.type) ||
                (!1 === e.data.saveState && l.stateRemove(l.stateId),
                "local" === e.data.type &&
            ...
            t(window).resize(function () {
              t(this).width() !== a && ((a = t(this).width()), l.fullRender()),
            ...
            var e = {
              ...
              enable: function () {
                t(o.table)
                  ...
                  .each(function () {
                    var a = this;
                    0 === t(this).find(".datatable-lock").length &&
                          ...
                          if (t(a).find(".datatable-lock").length > 0)
                            ...
                            t(a)
                              ...
                              e.lockEnabled.left.length > 0 &&
                                (t(o.wrap).addClass("datatable-lock"),
                                t(n).appendTo(a)),
                              (e.lockEnabled.left.length > 0 ||
              ...
              t(o.tableBody)
                ...
                .on("mouseenter", function () {
                  if (
                    ...
                    var e = t(this)
                        .closest(".datatable-row")
                        .addClass("datatable-row-hover"),
                      a = t(e).index() + 1;
                    t(e)
                      .closest(".datatable-lock")
                      .parent()
                      .find(".datatable-row:nth-child(" + a + ")")
                      .addClass("datatable-row-hover");
                  }
                })
            ...
            (o.initialDatatable = t(o).clone()),
              "TABLE" === t(o).prop("tagName")
                ? ((o.table = t(o)
                    ...
                    .addClass("datatable-table")),
                  0 === t(o.table).parents(".datatable").length &&
                    (o.table.wrap(
                      t("<div/>")
                        .addClass("datatable")
                        .addClass("datatable-" + i.layout.theme)
                    ),
              ...
              t(o.table)
                .removeClass("datatable-destroyed")
                .css("display", "block"),
              void 0 === t(o).attr("id") &&
            ...
            if (((o.dataSet = o.dataSet || []), 0 !== o.dataSet.length)) {
                    ...
                    .each(function (a, n) {
                      ...
                      if (void 0 !== i) {
                        ...
                        if (void 0 !== i.selector && !1 !== i.selector) {
                          if (
                            t(n).find('.checkbox [type="checkbox"]').length > 0
                          )
                            return;
                          t(n).addClass("datatable-cell-check");
                          var r = t("<label/>")
                            .addClass("checkbox checkbox-single")
                            .append(
                              t("<input/>")
                                .attr("type", "checkbox")
                                .attr("value", o)
                        ...
                        if (void 0 !== i.subtable && i.subtable) {
                          if (
                            t(n).find(".datatable-toggle-subtable").length > 0
                          )
                            return;
                          t(n)
                            .children()
                            .html(
                              t("<a/>")
                                .addClass("datatable-toggle-subtable")
                                .attr("href", "#")
                                .attr("data-value", o)
                                .append(
                                  t("<i/>").addClass(
              ...
              var a = function (a) {
                ...
                if (
                  ...
                  var o = t("<label/>")
                    .addClass("checkbox checkbox-single checkbox-all")
                    .append(
                      t("<input/>")
                        .attr("type", "checkbox")
                        .on("click", function () {
              ...
              i.layout.header &&
                a(t(o.tableHead).find(".datatable-row").first()),
                i.layout.footer &&
                  a(t(o.tableFoot).find(".datatable-row").first());
            }
          },
          maxWidthList: {},
          adjustCellsWidth: function () {
            var e = t(o.tableBody).innerWidth() - l.iconOffset,
              a = t(o.tableBody)
                .find(".datatable-row:first-child")
                .find(".datatable-cell")
                .not(".datatable-toggle-detail")
                .not(":hidden").length;
            if (a > 0) {
              e -= l.iconOffset * a;
            ...
            var e = {
              ...
              init: function () {
                ...
                if (i.layout.scroll) {
                  ...
                  t(r).find(".datatable-row").length > 0 && t(r).length > 0
                    ? ((e.scrollHead = t(o.tableHead).find(
                        "> .datatable-lock-scroll > .datatable-row"
                      )),
                      (e.scrollFoot = t(o.tableFoot).find(
                        "> .datatable-lock-scroll > .datatable-row"
                      )),
                      (e.tableLocked = t(o.tableBody).find(
                        ".datatable-lock:not(.datatable-lock-scroll)"
                      )),
                    ...
                    : t(o.tableBody).find(".datatable-row").length > 0 &&
                      ((e.scrollHead = t(o.tableHead).find("> .datatable-row")),
          ...
          initScrollbar: function (e, n) {
            if (e && e.nodeName) {
              ...
              var i = t(e).data("ps");
              a.hasClass(e, "ps") && void 0 !== i
                ? i.update()
                : ((i = new PerfectScrollbar(
                    e,
                    Object.assign(
                      {},
                      {
          ...
          dataRender: function (e) {
            t(o.table)
              .siblings(".datatable-pager")
              .removeClass("datatable-paging-loaded");
            var a = function () {
              ...
              n = function (e) {
                var n = function (e, a) {
                  t(e.pager).hasClass("datatable-paging-loaded") ||
                    (t(e.pager).remove(), e.init(a)),
                    t(e.pager)
                      .off()
                      .on("datatable-on-goto-page", function (n) {
                        t(e.pager).remove(), e.init(a);
                      });
                ...
                if ((t(o.wrap).removeClass("datatable-error"), i.pagination))
                  if (i.data.serverPaging && "local" !== i.data.type) {
                    ...
                    l.pagingObject =
                      null !== r ? l.paging(r) : l.paging(a(), n);
              ...
              (t.each(o.dataSet, function (n, r) {
                ...
                for (var p = 0; p < u; p += 1) {
                  ...
                  a.addClass(h, g.join(" ")),
                    ...
                    void 0 !== f.autoHide &&
                      (!0 !== f.autoHide
                        ? h.setAttribute("data-autohide-disabled", f.autoHide)
                        : h.setAttribute("data-autohide-enabled", f.autoHide)),
            ...
            var i = {
              ...
              init: function (e) {
                (i.meta = e),
                  ...
                  t(i.pager).hasClass("datatable-paging-loaded") ||
                    (t(i.pager).remove(),
                    0 !== i.meta.pages &&
                ...
                (i.pagerLayout.pagination = n),
                  ...
                  t("<li/>")
                    .append(
                      t("<a/>")
                        .attr("title", a.more)
                        .addClass(
                          "datatable-pager-link datatable-pager-link-more-prev"
                        )
                  ...
                  t("<li/>")
                    .append(
                      t("<input/>")
                        .attr("type", "text")
                        .addClass("datatable-pager-input form-control")
                        .attr("title", a.input)
                        .on("keyup", function () {
                ...
                t("<li/>")
                  .append(
                    t("<a/>")
                      .attr("title", a.more)
                      .addClass(
                        "datatable-pager-link datatable-pager-link-more-next"
                      )
                      .html(t("<i/>").addClass(e.more))
                      .on("click", i.gotoMorePage)
                  )
                  ...
                  l.getOption("toolbar.items.info") &&
                    (i.pagerLayout.info = t("<div/>")
                      .addClass("datatable-pager-info")
                      .append(t("<span/>").addClass("datatable-pager-detail"))),
                  t.each(l.getOption("toolbar.layout"), function (e, a) {
                    t(i.pagerLayout[a]).appendTo(i.pager);
                  });
                var p = t("<select/>")
                    .addClass("selectpicker datatable-pager-size")
                    .attr(
                      "title",
                      l.getOption(
              ...
              gotoPage: function (e) {
                e.preventDefault(),
                  t(this).hasClass("datatable-pager-link-active") ||
              ...
              updatePerpage: function (e) {
                e.preventDefault(),
                  ...
                  t(i.pager)
                    .find("select.datatable-pager-size")
                    .val(i.meta.perpage)
              ...
              addPaginateEvent: function (e) {
                t(o)
                  ...
                  .on(i.paginateEvent, function (e, a) {
                    ...
                    t(n)
                      .find(".datatable-pager-link-active")
                      .removeClass("datatable-pager-link-active"),
                      t(n)
                        .find(
                        ...
                        .addClass("datatable-pager-link-active"),
                      t(n)
                        .find(".datatable-pager-link-prev")
                        .attr("data-page", Math.max(a.page - 1, 1)),
                      t(n)
                        .find(".datatable-pager-link-next")
                        .attr("data-page", Math.min(a.page + 1, a.pages)),
                      t(i.pager).each(function () {
                        t(this)
                          .find('.datatable-pager-input[type="text"]')
                          .prop("value", a.page);
                      }),
                      l.setDataSourceParam("pagination", {
                        page: i.meta.page,
                      ...
                      t(o.table)
                        ...
                        .prop("checked", !1),
                      t(o.table)
                        .find(".datatable-row-active")
                        .removeClass("datatable-row-active"),
                      i.updateInfo.call(),
                      i.pagingBreakpoint.call();
                  });
              },
              updateInfo: function () {
                ...
                t(i.pager)
                  .find(".datatable-pager-info")
                  .find(".datatable-pager-detail")
                  .html(
                    l.dataPlaceholder(
                        ...
                        if (a.isInResponsiveRange(o)) {
                          switch (o) {
                            ...
                            case "mobile":
                              t(r).show(),
                                t(e)
                                  .find(".datatable-pager-link-more-prev")
                                  .closest("li")
                                  .hide(),
                                t(e)
                                  .find(".datatable-pager-link-more-next")
                                  .closest("li")
                                  .hide(),
                                t(e)
                                  .find(".datatable-pager-link-number")
                                  .closest("li")
                                  .hide();
                          }
                          return !1;
              ...
              paginationUpdate: function () {
                ...
                t(n).each(function (e, a) {
                  ...
                  1 === i.meta.page
                    ? (t(r)
                        .attr("disabled", !0)
                        .addClass("datatable-pager-link-disabled"),
                      t(s)
                        .attr("disabled", !0)
                        .addClass("datatable-pager-link-disabled"))
                    : (t(r)
                        .removeAttr("disabled")
                        .removeClass("datatable-pager-link-disabled"),
                      t(s)
                        .removeAttr("disabled")
                        .removeClass("datatable-pager-link-disabled")),
              ...
              if (void 0 !== i.responsive || void 0 !== i.visible) {
                ...
                setTimeout(function () {
                  !1 === l.getObject("visible", i)
                    ? t(s).hide()
                    : (a.getBreakpoint(l.getObject("responsive.hidden", i)) >= e
                        ? t(s).hide()
                        : t(s).show(),
                      a.getBreakpoint(l.getObject("responsive.visible", i)) <= e
                        ? t(s).show()
                        : t(s).hide());
                });
              }
          ...
          setupSubDatatable: function () {
            ...
            if (
              "function" == typeof e &&
              !(t(o.table).find(".datatable-subtable").length > 0)
            ) {
              ...
              var a = function (a) {
                  ...
                  0 === t(r).length &&
                    ((r = t("<tr/>")
                      .addClass("datatable-row-subtable datatable-row-loading")
                      .hide()
                      .append(
                        t("<td/>")
                          .addClass("datatable-subtable")
                          .attr("colspan", l.getTotalColumns())
                      )),
                    t(n).after(r),
                    t(n).hasClass("datatable-row-even") &&
                      t(r).addClass("datatable-row-subtable-even")),
                    t(r).toggle();
                  var s = t(r).find(".datatable-subtable"),
                    d = t(this)
                      .closest("[data-field]:first-child")
                      .find(".datatable-toggle-subtable")
                      .data("value"),
                    c = t(this).find("i").removeAttr("class");
                  t(n).hasClass("datatable-row-subtable-expanded")
                    ? (t(c).addClass(
                        l.getOption("layout.icons.rowDetail.collapse")
                      ),
                      t(n).removeClass("datatable-row-subtable-expanded"),
                      t(o).trigger("datatable-on-collapse-subtable", [n]))
                    : (t(c).addClass(
                    ...
                    0 === t(s).find(".datatable").length &&
                      (t.map(o.dataSet, function (t, e) {
                        return (
                          d === t[i.columns[0].field] && ((a.data = t), !0)
                        );
                      }),
                      (a.detailCell = s),
                      (a.parentRow = n),
                      ...
                      t(s)
                        .children(".datatable")
                        .on("datatable-on-init", function (e) {
                    ...
                    .each(function (e, i) {
                      ...
                      if (void 0 !== o) {
                        ...
                        if (void 0 !== o.subtable && o.subtable) {
                          if (
                            t(i).find(".datatable-toggle-subtable").length > 0
                          )
                            return;
                          t(i).html(
                            t("<a/>")
              ...
              if (t(n).hasClass("datatable-row-detail"))
                ...
                t(o).each(function () {
                  ...
                  (void 0 !== a && !1 === a.visible) ||
                    t(s).append(
                      t('<tr class="datatable-row"></tr>')
                        .append(
                          t('<td class="datatable-cell"></td>').append(
              ...
              t(o.table).find(".datatable-cell").show(),
                ...
                e &&
                  t(o.tableBody)
                    .find(".datatable-row")
                    .each(function () {
                      0 === t(this).find(".datatable-toggle-detail").length &&
                        t(this).prepend(
                          t("<td/>")
                            .addClass("datatable-cell datatable-toggle-detail")
                            .append(
                              t("<a/>")
                                .addClass("datatable-toggle-detail")
                                .attr("href", "")
                                .on("click", n)
                                .append(
                                  '<i class="' +
                        ...
                        0 ===
                        t(o.tableHead).find(".datatable-toggle-detail").length
                          ? (t(o.tableHead)
                              .find(".datatable-row")
                              .first()
                              .prepend(
          ...
          setAutoColumns: function () {
            l.getOption("data.autoColumns") &&
              ...
              l.setHeadTitle(),
              l.getOption("layout.footer") &&
                (t(o.tableFoot).find(".datatable-row").remove(),
          ...
          getTableId: function (e) {
            ...
            var a = t(o).attr("id");
            return (
              void 0 === a && (a = t(o).attr("class").split(" ")[0]), a + e
            );
          },
          ...
          stateGet: function (t, e) {
            if (
              ...
              var a = null;
              return (
                localStorage && (a = localStorage.getItem(t)),
          ...
          getOneRow: function (e, a, n) {
            void 0 === n && (n = !0);
            var i = t(e).find(
              ".datatable-row:not(.datatable-row-detail):nth-child(" + a + ")"
            );
          ...
          sortColumn: function (e, a, n) {
            ...
            -1 !== r &&
              (l = t(o.tableBody)
                .find(".datatable-lock:nth-child(" + (r + 1) + ")")
                .find(".datatable-row"));
            var s = t(l).parent();
            t(l)
              .sort(function (e, o) {
          ...
          sorting: function () {
            var e = {
              init: function () {
                i.sortable &&
                  (t(o.tableHead)
                    .find(".datatable-cell:not(.datatable-cell-check)")
                    .addClass("datatable-cell-sort")
                    .off("click")
              ...
              setIcon: function () {
                ...
                if (!t.isEmptyObject(e)) {
                  ...
                  if (
                    ...
                    var n = t(o.tableHead)
                        .find('.datatable-cell[data-field="' + e.field + '"]')
              ...
              sortClick: function (n) {
                ...
                if (
                  ...
                  (t(o.tableHead)
                    .find("th")
                    .removeClass("datatable-cell-sorted"),
          ...
          resetScroll: function () {
            void 0 === i.detail &&
              1 === l.getDepth() &&
              (t(o.table).find(".datatable-row").css("left", 0),
          ...
          rowEvenOdd: function () {
            t(o.tableBody)
              .find(".datatable-row")
              .removeClass("datatable-row-even"),
              t(o.wrap).hasClass("datatable-subtable")
                ? t(o.tableBody)
                    .find(".datatable-row:not(.datatable-row-detail):even")
                    .addClass("datatable-row-even")
                : t(o.tableBody)
                    .find(".datatable-row:nth-child(even)")
                    .addClass("datatable-row-even");
          },
          timer: 0,
          redraw: function () {
          ...
          getRecord: function (e) {
            return (
              ...
              t(o.tableBody)
                .find(".datatable-cell:first-child")
                .each(function (a, n) {
                  if (e == t(n).text()) {
          ...
          setActive: function (e) {
            "string" == typeof e &&
              (e = t(o.tableBody).find(
                '.checkbox-single > [type="checkbox"][value="' + e + '"]'
              )),
              t(e).prop("checked", !0);
            var a = [];
          ...
          setActiveAll: function (e) {
            var a = t(o.table)
              .find("> tbody, > thead")
              .find("tr")
              .not(".datatable-row-subtable")
              .find('.datatable-cell-check [type="checkbox"]');
            e ? l.setActive(a) : l.setInactive(a);
          },
          setSelectedRecords: function () {
            return (
              (o.API.record = t(o.tableBody).find(".datatable-row-active")), o
            );
          },
              ...
              (n = function () {
                ...
                "object" == typeof a &&
                  ...
                  o.setDataSourceParam(
                    "pagination",
                    Object.assign({}, o.getDataSourceParam("pagination"), {
                      page: 1,
                    })
                  ),
                  i.data.serverFiltering || l.localDataUpdate(),
          ...
          getCurrentPage: function () {
            return (
              t(o.table)
                ...
                .last()
                .find(".datatable-pager-nav")
                .find(".datatable-pager-link.datatable-pager-link-active")
                .data("page") || 1
            );
          },
          ...
          row: function (e) {
            return (
              l.rows(e), (l.nodeTr = l.recentNode = t(l.nodeTr).first()), o
            );
          },
          rows: function (e) {
            return (
              l.isLocked()
                ? (l.nodeTr = l.recentNode =
                    t(o.tableBody)
                      .find(e)
                      .filter(".datatable-lock-scroll > .datatable-row"))
                : (l.nodeTr = l.recentNode =
                    t(o.tableBody).find(e).filter(".datatable-row")),
              o
            );
          },
          column: function (e) {
          ...
          columns: function (e) {
            ...
            return (
              n.length > 0
                ...
                : (l.nodeCols = l.recentNode =
                    t(a).find(e).filter(".datatable-cell")),
              o
            );
          },
          cell: function (e) {
            return (
              l.cells(e), (l.nodeTd = l.recentNode = t(l.nodeTd).first()), o
            );
          },
          cells: function (e) {
            ...
            if (t(l.recentNode.length)) {
              ...
              if (l.recentNode === l.nodeCols) {
                ...
                if (l.isLocked()) {
                  ...
                  o
                    ? (n += a.left.length + 1)
                    : t(l.recentNode).closest(".datatable-lock-right").length &&
                      (n += a.left.length + o + 1);
                }
              }
              e
                ? (l.recentNode === l.nodeCols && delete i.columns[n].visible,
                  t(l.recentNode).show())
                : (l.recentNode === l.nodeCols &&
                    l.setOption("columns." + n + ".visible", !1),
                  t(l.recentNode).hide()),
                l.columnHide(),
                l.redraw();
            }
        ...
        if (
          ...
          if ("string" == typeof i) {
            ...
            o.data(e) ||
              t(this).hasClass("datatable-loaded") ||
              ((o.dataSet = null),
              (o.textAlign = {
    ...
    (t.fn.KTDatatable = t.fn.KTDatatable || {}),
      (t.fn.KTDatatable.checkbox = function (e, a) {
        var n = {
          ...
          initEvent: function () {
            t(e.tableHead)
              .find('.checkbox-all > [type="checkbox"]')
              .click(function (i) {
                if (
...
var KTLayoutAsideMenu = (function () {
  ...
  return {
    init: function (a) {
      ...
      (t = KTUtil.getById(a)) &&
        ((i =
          "1" === KTUtil.attr(t, "data-menu-dropdown")
            ? "dropdown"
            : "accordion"),
        "1" === KTUtil.attr(t, "data-menu-scroll") &&
          (n = {
            rememberPosition: !0,
            height: function () {
              var e = parseInt(KTUtil.getViewPort().height);
              return (
                KTUtil.isBreakpointUp("lg") && (e -= KTLayoutBrand.getHeight()),
                (e -=
                  parseInt(KTUtil.css(t, "marginBottom")) +
                  parseInt(KTUtil.css(t, "marginTop")))
              );
            },
          }),
        (e = new KTMenu(t, {
        ...
        })).on("submenuToggle", function (t) {
          if (
            !0 === KTLayoutAside.isMinimized() &&
            !1 === KTLayoutAside.isHoverable()
          )
            return !1;
        }));
    },
      ...
      (e = KTUtil.getById(n)),
        ...
        e &&
          ((a = new KTToggle(e, {
            ...
            KTUtil.addClass(t, "aside-minimizing"),
              KTUtil.transitionEnd(t, function () {
                KTUtil.removeClass(t, "aside-minimizing");
              }),
              KTLayoutStickyCard.update(),
              KTLayoutHeaderMenu.pauseDropdownHover(800),
              KTLayoutAsideMenu.pauseDropdownHover(800),
              KTCookie.setCookie("kt_aside_toggle_state", e.getState());
          }),
          a.on("beforeToggle", function (e) {
            !1 === KTUtil.hasClass(t, "aside-minimize") &&
              KTUtil.hasClass(t, "aside-minimize-hover") &&
              KTUtil.removeClass(t, "aside-minimize-hover");
          }));
    },
    getElement: function () {
      return e;
...
var KTLayoutAside = (function () {
  ...
  return {
    init: function (n) {
      var i, o, l;
      ((e = KTUtil.getById(n)), (t = KTUtil.getBody()), e) &&
        ((l = KTUtil.hasClass(e, "aside-offcanvas-default")
        ...
        KTUtil.hasClass(t, "aside-fixed") &&
          KTUtil.hasClass(t, "aside-minimize-hoverable") &&
          (KTUtil.addEvent(e, "mouseenter", function (e) {
            e.preventDefault(),
              !1 !== KTUtil.isBreakpointUp("lg") &&
                (o && (clearTimeout(o), (o = null)),
                (i = setTimeout(function () {
                  KTUtil.hasClass(t, "aside-minimize") &&
                    KTUtil.isBreakpointUp("lg") &&
                    (KTUtil.removeClass(t, "aside-minimize"),
                    KTUtil.addClass(t, "aside-minimize-hover"),
                    KTLayoutAsideMenu.getMenu().scrollUpdate(),
                    KTLayoutAsideMenu.getMenu().scrollTop());
                }, 50)));
          }),
          KTUtil.addEvent(e, "mouseleave", function (e) {
            e.preventDefault(),
              !1 !== KTUtil.isBreakpointUp("lg") &&
                ...
                (o = setTimeout(function () {
                  KTUtil.hasClass(t, "aside-minimize-hover") &&
                    KTUtil.isBreakpointUp("lg") &&
                    (KTUtil.removeClass(t, "aside-minimize-hover"),
                    KTUtil.addClass(t, "aside-minimize"),
                    KTLayoutAsideMenu.getMenu().scrollUpdate(),
                    KTLayoutAsideMenu.getMenu().scrollTop());
                }, 100)));
          })));
...
var KTLayoutContent = (function () {
  ...
  return {
    ...
    getHeight: function () {
      return (
        (e = KTUtil.getViewPort().height),
        t &&
          (e =
            e -
            parseInt(KTUtil.css(t, "paddingTop")) -
            parseInt(KTUtil.css(t, "paddingBottom"))),
        (e -= KTLayoutHeader.getHeight()),
        (e -= KTLayoutSubheader.getHeight()),
        (e -= KTLayoutFooter.getHeight())
      );
      var e;
    },
    getElement: function () {
        ...
        (!(function () {
          ...
          KTUtil.scrollInit(n, {
            ...
            height: function () {
              ...
              return (
                e &&
                  ((o -= parseInt(KTUtil.actualHeight(e))),
                  (o -= parseInt(KTUtil.css(e, "marginTop"))),
                  (o -= parseInt(KTUtil.css(e, "marginBottom")))),
                a &&
                  ((o -= parseInt(KTUtil.css(a, "marginTop"))),
                  (o -= parseInt(KTUtil.css(a, "marginBottom")))),
                n &&
                  ((o -= parseInt(KTUtil.css(n, "marginTop"))),
                  (o -= parseInt(KTUtil.css(n, "marginBottom")))),
                i &&
                  ((o -= parseInt(KTUtil.actualHeight(i))),
                  (o -= parseInt(KTUtil.css(i, "marginTop"))),
                  (o -= parseInt(KTUtil.css(i, "marginBottom")))),
                (o -= parseInt(KTUtil.css(t, "paddingTop"))),
                (o -= parseInt(KTUtil.css(t, "paddingBottom"))),
                (o -= 2)
              );
            },
          }),
    ...
    !(function (t) {
      ...
      for (var a = 0; a < e.length; ++a) {
        ...
        new ClipboardJS(i, {
          ...
          KTUtil.addClass(t.trigger, "example-copied"),
            t.clearSelection(),
            setTimeout(function () {
      ...
      (function (t) {
        if (void 0 === (e = t))
          var e = document.querySelectorAll(".example.example-compact");
        for (var a = 0; a < e.length; ++a) {
          var n = e[a],
          ...
          KTUtil.addEvent(i, "click", function () {
            var t = this.closest(".example"),
              ...
              a = this;
            KTUtil.hasClass(this, "example-toggled")
              ? KTUtil.slideUp(e, 300, function () {
                  KTUtil.removeClass(a, "example-toggled"),
                    KTUtil.removeClass(e, "example-code-on"),
                    KTUtil.hide(e);
                })
              : (KTUtil.addClass(e, "example-code-on"),
                KTUtil.addClass(this, "example-toggled"),
                KTUtil.slideDown(e, 300, function () {
                  KTUtil.show(e);
                }));
          }),
            new ClipboardJS(o, {
...
var KTLayoutQuickActions = (function () {
  ...
  return {
    init: function (e) {
      var a, n;
      (t = KTUtil.getById(e)) &&
        ((a = KTUtil.find(t, ".offcanvas-header")),
          ...
          height: function () {
            ...
            return (
              a &&
                ...
                (e -= parseInt(KTUtil.css(a, "marginTop"))),
                (e -= parseInt(KTUtil.css(a, "marginBottom")))),
              n &&
                ((e -= parseInt(KTUtil.css(n, "marginTop"))),
                (e -= parseInt(KTUtil.css(n, "marginBottom")))),
...
var KTLayoutQuickPanel = (function () {
  var t,
    ...
    i = function () {
      ...
      return (
        e &&
          ((n -= parseInt(KTUtil.actualHeight(e))),
          (n -= parseInt(KTUtil.css(e, "marginTop"))),
          (n -= parseInt(KTUtil.css(e, "marginBottom")))),
        a &&
          ((n -= parseInt(KTUtil.css(a, "marginTop"))),
          (n -= parseInt(KTUtil.css(a, "marginBottom")))),
  ...
  return {
    init: function (o) {
      (t = KTUtil.getById(o)),
        (e = KTUtil.getById("kt_quick_panel_notifications")),
        (a = KTUtil.getById("kt_quick_panel_logs")),
        (n = KTUtil.getById("kt_quick_panel_settings")),
        new KTOffcanvas(t, {
          overlay: !0,
          baseClass: "offcanvas",
          placement: "right",
  ...
  return {
    init: function (e) {
      ...
      (t = KTUtil.getById(e)) &&
        ((a = KTUtil.find(t, ".offcanvas-header")),
        (n = KTUtil.find(t, ".offcanvas-content")),
        (i = KTUtil.find(t, ".quick-search-form")),
        (o = KTUtil.find(t, ".quick-search-wrapper")),
        new KTOffcanvas(t, {
          overlay: !0,
          baseClass: "offcanvas",
          placement: "right",
          ...
          height: function () {
            ...
            return (
              ...
              n &&
                ...
                (e -= parseInt(KTUtil.css(n, "marginBottom")))),
              o &&
                ((e -= parseInt(KTUtil.actualHeight(i))),
                (e -= parseInt(KTUtil.css(i, "marginTop"))),
                (e -= parseInt(KTUtil.css(i, "marginBottom"))),
                (e -= parseInt(KTUtil.css(o, "marginTop"))),
                (e -= parseInt(KTUtil.css(o, "marginBottom")))),
              (e -= parseInt(KTUtil.css(t, "paddingTop"))),
              (e -= parseInt(KTUtil.css(t, "paddingBottom"))),
              (e -= 2)
            );
...
var KTLayoutScrolltop = (function () {
  ...
  return {
    init: function (e) {
      (t = KTUtil.getById(e)) &&
        new KTScrolltop(t, { offset: 300, speed: 600 });
    },
    getElement: function () {
      return t;
    },
...
var KTLayoutSearch = function () {
  var t,
    ...
    c = !1,
    u = !1,
    p = "quick-search-has-result",
    f = function () {
      (u = !1),
        KTUtil.removeClass(r, "spinner spinner-sm spinner-primary"),
    ...
    h = function () {
      if (d && s === a.value)
        return f(), KTUtil.addClass(t, p), g(), void KTUtil.scrollUpdate(i);
      (s = a.value),
        KTUtil.removeClass(t, p),
        (u = !0),
        KTUtil.addClass(r, "spinner spinner-sm spinner-primary"),
        n && KTUtil.hide(n),
        m(),
        setTimeout(function () {
          $.ajax({
    ...
    b = function () {
      if (a.value.length < 2) return f(), void m();
      1 != u &&
        (c && clearTimeout(c),
  ...
  return {
    init: function (s) {
      (t = KTUtil.getById(s)) &&
        ((e = KTUtil.find(t, ".quick-search-form")),
        (a = KTUtil.find(t, ".form-control")),
        (n = KTUtil.find(t, ".quick-search-close")),
        (i = KTUtil.find(t, ".quick-search-wrapper")),
        (o = KTUtil.find(t, ".dropdown-menu")),
        (l = KTUtil.find(t, '[data-toggle="dropdown"]')),
        KTUtil.find(t, ".input-group"),
        (r = KTUtil.find(t, ".input-group .input-group-append")),
        KTUtil.addEvent(a, "keyup", b),
        KTUtil.addEvent(a, "focus", b),
        (e.onkeypress = function (t) {
          13 == (t.charCode || t.keyCode || 0) && t.preventDefault();
        }),
        KTUtil.addEvent(n, "click", v));
    },
  };
};
  ...
  KTLayoutStickyCard = (function () {
    ...
    return {
      init: function (a) {
        ...
        (t = KTUtil.getById(a)) &&
          ((n = 300),
          void 0 !== KTLayoutHeader && (n = KTLayoutHeader.getHeight()),
          (e = new KTCard(t, {
            sticky: {
              offset: n,
              zIndex: 90,
              position: {
                top: function () {
                  ...
                  return (
                    KTUtil.getBody(),
                    KTUtil.isBreakpointUp("lg")
                      ? (void 0 !== KTLayoutHeader &&
                          KTLayoutHeader.isFixed() &&
                          (t += KTLayoutHeader.getHeight()),
                        void 0 !== KTLayoutSubheader &&
                          KTLayoutSubheader.isFixed() &&
                          (t += KTLayoutSubheader.getHeight()))
                      : void 0 !== KTLayoutHeader &&
                        KTLayoutHeader.isFixedForMobile() &&
                        (t += KTLayoutHeader.getHeightForMobile()),
                    (t -= 1)
                  );
                },
                left: function (e) {
                ...
                right: function (e) {
                  ...
                  return (
                    parseInt(KTUtil.css(a, "width")) - n - KTUtil.offset(t).left
                  );
                },
              },
            },
    ...
    e = function () {
      ...
      (i =
        (i =
          (i =
            (i =
              (i -= parseInt(KTUtil.actualHeight(n))) -
              parseInt(KTUtil.css(t, "marginTop")) -
              parseInt(KTUtil.css(t, "marginBottom"))) -
            parseInt(KTUtil.css(t, "paddingTop")) -
            parseInt(KTUtil.css(t, "paddingBottom"))) -
          parseInt(KTUtil.css(a, "paddingTop")) -
          parseInt(KTUtil.css(a, "paddingBottom"))) -
        parseInt(KTUtil.css(a, "marginTop")) -
        parseInt(KTUtil.css(a, "marginBottom"))),
        (i -= 3),
        KTUtil.css(e, "height", i + "px");
    };
  return {
    init: function (a) {
      (t = KTUtil.getById(a)) &&
